...
export const INITIAL_SECTORS = [
  {
    ...
    capabilitiesTitle: 'Key Domain Capabilities',
    capabilitiesTitle_ar: 'أبرز القدرات التنفيذية في القطاع',
  ...
  },
  {
    ...
    description_ar: 'إطلاق المخططات الرئيسية للمشاريع العملاقة، مراكز المبيعات التفاعلية الغامرة، مراسم وضع حجر الأساس، وحفلات المعاينة الحصرية لكبار المستثمرين.',
    capabilitiesTitle: 'Key Domain Capabilities',
    capabilitiesTitle_ar: 'أبرز القدرات التنفيذية في القطاع',
